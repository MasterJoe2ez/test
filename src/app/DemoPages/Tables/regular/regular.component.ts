...
export class RegularComponent implements OnInit {
  ...
  save(){
    ...
    this.httpClient.post('http://localhost:8080/api/country/save',country).subscribe((res: any) => {
      this.getData();
    });
  }
  delete(countryId: number){
    this.httpClient.get('http://localhost:8080/api/country/delete?countryId='+countryId).subscribe((res: any) => {
      this.getData();
    });
  }
